...
export default function TournamentSpotlight({ standings = [] }: TournamentSpotlightProps) {
    ...
    <section className="mx-auto max-w-7xl px-4 pb-10 sm:px-6">
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div className="rounded-xl bg-card ring-1 ring-lborder overflow-hidden">
          <div className="p-5">
            <h3 className="text-base font-bold text-mtext">{PSL_DATA.season} Tournament Spotlight</h3>
            <div className="mt-3 flex flex-wrap items-center gap-4 text-[11px] font-bold text-stext">
          ...
          <div className="p-5">
            <Link
              href="/psl"
              className="inline-flex items-center gap-1.5 text-xs font-semibold text-accent transition-colors hover:text-accent2"
            >
