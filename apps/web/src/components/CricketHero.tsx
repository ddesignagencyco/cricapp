          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-4 w-full max-w-xs sm:max-w-sm lg:max-w-xs">
            {[
              ...
              <Link
                key={item.label}
                href={item.href}
                className="group flex flex-col items-start gap-2 rounded-md bg-[#07111F]/70 p-4 ring-1 ring-white/15 backdrop-blur-md transition-colors hover:bg-[#07111F]/80 hover:ring-white/30"
              >
                <div className="grid h-9 w-9 place-items-center rounded-md bg-white/10">
                  <item.icon size={18} className="text-accent2" />
                </div>
                <div>
