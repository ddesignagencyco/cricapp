...
export default function LiveStreamsBoard({ streams }) {
...
function StreamPlayer({ stream, viewers }) {
  return (
...
function StreamList({ streams, featuredId, viewerMap, onSelect }) {
  return (
...
function LiveChat({ chat, message, setMessage }) {
  const messages = chat || [];
  return (
