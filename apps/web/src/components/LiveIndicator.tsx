...
export default function LiveIndicator({ label = 'LIVE', className = '' }: LiveIndicatorProps) {
  return (
    <span
      className={`inline-flex items-center gap-2 rounded-md bg-accent2/15 px-2.5 py-1 text-xs font-black uppercase tracking-widest text-accent2 ring-1 ring-inset ring-accent2/40 ${className}`}
    >
