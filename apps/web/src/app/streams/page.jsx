import LiveStreamsBoard from '../../components/boards/LiveStreamsBoard.jsx';
import { fetchMatches, fetchStreams } from '../../services/cricketApi.js';
...
export default async function StreamsPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6">
      <LiveStreamsBoard streams={streams} matches={matches} />
    </div>
  );
}
